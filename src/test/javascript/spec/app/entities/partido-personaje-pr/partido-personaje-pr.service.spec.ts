...
describe('Service Tests', () => {
    ...
    describe('PartidoPersonajePr Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PartidoPersonajePrService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/partido-personajes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PartidoPersonajePr', () => {
