...
describe('Service Tests', () => {
    ...
    describe('CargoPersonajePr Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CargoPersonajePrService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/cargo-personajes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CargoPersonajePr', () => {
