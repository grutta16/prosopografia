...
describe('Service Tests', () => {
    ...
    describe('TipoProfesionPr Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TipoProfesionPrService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tipo-profesions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TipoProfesionPr', () => {
