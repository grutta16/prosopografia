...
describe('Service Tests', () => {
    ...
    describe('FamiliarPersonajePr Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(FamiliarPersonajePrService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/familiar-personajes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return FamiliarPersonajePr', () => {
