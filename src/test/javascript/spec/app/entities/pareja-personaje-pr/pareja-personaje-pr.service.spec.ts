...
describe('Service Tests', () => {
    ...
    describe('ParejaPersonajePr Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ParejaPersonajePrService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/pareja-personajes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ParejaPersonajePr', () => {
