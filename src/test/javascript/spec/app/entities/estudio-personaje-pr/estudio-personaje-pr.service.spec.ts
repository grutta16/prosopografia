...
describe('Service Tests', () => {
    ...
    describe('EstudioPersonajePr Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EstudioPersonajePrService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/estudio-personajes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return EstudioPersonajePr', () => {
