...
describe('Service Tests', () => {
    ...
    describe('AsociacionPersonajePr Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AsociacionPersonajePrService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/asociacion-personajes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return AsociacionPersonajePr', () => {
