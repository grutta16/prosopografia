...
describe('Service Tests', () => {
    ...
    describe('ReligionPersonajePr Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ReligionPersonajePrService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/religion-personajes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ReligionPersonajePr', () => {
