...
/**
 * Performance test for the Personaje entity.
 */
class PersonajeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Personaje entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created personaje")
                .get("${new_personaje_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created personaje")
            .delete("${new_personaje_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
