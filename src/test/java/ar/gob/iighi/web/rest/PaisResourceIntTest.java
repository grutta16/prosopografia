...
public class PaisResourceIntTest {
    ...
    public void createPais() throws Exception {
        ...
        Pais paisEs = paisSearchRepository.findOne(testPais.getId());
        assertThat(paisEs).isEqualToIgnoringGivenFields(testPais);
    }
    ...
    public void deletePais() throws Exception {
        ...
        boolean paisExistsInEs = paisSearchRepository.exists(pais.getId());
        assertThat(paisExistsInEs).isFalse();
