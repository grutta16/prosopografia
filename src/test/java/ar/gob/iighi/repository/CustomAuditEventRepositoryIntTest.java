...
import ar.gob.iighi.config.audit.AuditEventConverter;
import ar.gob.iighi.domain.PersistentAuditEvent;
...
import static ar.gob.iighi.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
